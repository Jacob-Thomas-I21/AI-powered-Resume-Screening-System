# -*- coding: utf-8 -*-
"""AI resume analyser(AI-resu)[data preprocessing,skill extraction BERT Embeddings].ipynb
...
df = pd.read_csv('/content/data/extracted_skills.csv')
print(df.head())
...
job_df =pd.read_csv("/content/drive/MyDrive/Project 1/Dataset/job description/job_title_des.csv")
print(job_df.head())
